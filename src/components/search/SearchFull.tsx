...
const SearchFull: React.FC = () => {
  ...
  const [searchType, setSearhType] = useState<number>(1);
  ...
  return (
    <div className="hidden omd:block w-full h-[420px] bg-[url('/banner/bg_img_mytour.webp')] bg-cover bg-center z-0">
      <div className="custom-page-padding w-full h-full relative">
        {/* Top */}
        <div className="pt-12">
          <div className="bg-white shadow rounded-t-lg mx-auto w-full text-[17px] font-semibold flex gap-8 pt-3 justify-center border-b border-b-slate-200">
            <div
              className={`flex items-center gap-1 relative pb-2 cursor-pointer ${
                searchType === 1
                  ? "text-[#FF3366] border-b-3 border-b-[#FF3366]"
                  : ""
              }`}
              onClick={() => setSearhType(1)}
            >
              <Hotel className="w-5 h-5" />
              <span>Khách sạn</span>
              <span className="px-1 rounded-t-md rounded-br-md bg-[#FF3366] absolute -top-5 left-6 text-12 text-white font-semibold">
                -400k
              </span>
            </div>
            <div
              ...
              onClick={() => setSearhType(2)}
            >
              <Plane className="w-5 h-5" />
              <span>Vé máy bay</span>
              <span className="px-1 rounded-t-md rounded-br-md bg-white border border-[#FF3366] absolute -top-5 left-6 text-12 text-[#FF3366] font-semibold">
                -300k
              </span>
            </div>
            <div
            ...
            <div
              ...
              onClick={() => setSearhType(4)}
            >
              <Hotel className="w-5 h-5" />
              <span>Biệt thự, Homestay</span>
            </div>
          </div>
        </div>
        {/* Bot */}
        <div className="bg-white shadow rounded-b-lg flex flex-col xl:flex-row overflow-hidden">
          {/* Địa điểm */}
          <div
          ...
          <div className={"flex flex-col sm:flex-row xl:w-2/3"}>
            <div
              ...
              after:absolute after:left-6 after:bottom-1 after:h-[2px] after:bg-[#FF3366] border-l border-r border-slate-200
        ...
        {openLocation && (
          <div className="w-[84%] xl:w-[76%] p-4 bg-white shadow rounded-lg flex flex-col sm:flex-row absolute left-1/2 -translate-x-1/2 bottom:0 mt-2 z-10">
              ...
              <div className="w-2/3 md:w-[400px] flex flex-col px-4">
                <div className="flex items-center justify-between py-4 border-b-[1px] border-slate-300">
                  ...
                  <div className="flex gap-2">
                    <button
                      className={`w-8 h-8 border-[2px] leading-0 rounded-full flex items-center justify-center ${
                        roomCount === 1
                    ...
                    <div className="mt-1 font-semibold">{roomCount}</div>
                    <button
                      className="w-8 h-8 border-[2px] leading-0 border-[#FF3366] text-[#FF3366] rounded-full flex items-center justify-center"
                      onClick={() =>
                        setRoomCount((prev) => Math.max(prev + 1, 0))
                      }
                    >
                ...
                <div className="flex items-center justify-between py-4 border-b-[1px] border-slate-300">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="mt-1 font-semibold">{adultCount}</div>
                    <button
                      className="w-8 h-8 border-[2px] border-[#FF3366] text-[#FF3366] rounded-full flex items-center justify-center"
                      onClick={() =>
                        setAdultCount((prev) => Math.max(prev + 1, 0))
                      }
                    >
                ...
                <div className="flex items-center justify-between py-4 border-b-[1px] border-slate-300">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="mt-1 font-semibold">{childCount}</div>
                    <button
                      className="w-8 h-8 border-[2px] border-[#FF3366] text-[#FF3366] rounded-full flex items-center justify-center"
                      onClick={() =>
                        setChildCount((prev) => Math.max(prev + 1, 0))
