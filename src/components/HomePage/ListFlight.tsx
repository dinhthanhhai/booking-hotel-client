  ...
  return (
    <div className="custom-page-padding pt-8 pb-10 bg-white">
      ...
      <div className="mt-5 relative">
        ...
        <button
          onClick={goPrev}
          className="hidden omd:block absolute top-[52%] -left-5 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md hover:bg-gray-100"
        >
        ...
        <button
          onClick={goNext}
          className="hidden omd:block absolute top-[52%] -right-5 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md hover:bg-gray-100"
        >
