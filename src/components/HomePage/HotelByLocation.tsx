  ...
  return (
    <div className="custom-page-padding pt-10 pb-12">
      ...
      <div className="mt-10 relative">
        ...
        <button
          onClick={goPrev}
          className="hidden omd:block absolute top-[40%] -left-5 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-sm hover:bg-gray-100"
        >
        ...
        <button
          onClick={goNext}
          className="hidden omd:block absolute top-[40%] -right-5 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-sm hover:bg-gray-100"
        >
